# Flats
___
Имитация каталога квартир. Данные приходят с сервера, рендерятся и 
выводятся на страницу. Есть возможность отметить, понравившуюся квартиру.</br>
ВАЖНО!!! </br>
Чтобы запустить проект установите json-server через npm и запустите его: </br>
`json-server src/entities.json`</br>
Потому что fetch запрос настроен на localhost с портом 3000
___
...
Данные получаем с сервера через fetch. Есть возможность отметить квартиру.
</br></br>
